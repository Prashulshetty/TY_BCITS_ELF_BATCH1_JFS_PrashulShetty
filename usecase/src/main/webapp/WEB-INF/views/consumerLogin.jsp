...
<body style="background-color: lightblue">
	...
	%>
	<div
style="color: red; font-size: 35px; font: bold; margin-right: 50px" align="center">
	...
	<div
		...
		<form onsubmit="validation(); return false" action="./LoginPage"
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Email ID</label> <input id="email"
					name="email" type="email" placeholder="Enter email Id"
					class="form-control" id="exampleInputEmail1"
					aria-describedby="emailHelp"> <span id="uName"
			...
			<div class="form-group">
				<label for="exampleInputPassword1">Password</label> <input
					...
					id="exampleInputPassword1"> <span id="uPsw"
			...
			<div class="form-group form-check ">
				...
				<div class="float-left">
					<input onclick="checkBox()" id="checkbox" type="checkbox"
						name="checkbox" class="form-check-input"> <label
						class="form-check-label" for="exampleCheck1">Show Password</label>
				</div>
				</p>
			</div>
			<button type="submit"
