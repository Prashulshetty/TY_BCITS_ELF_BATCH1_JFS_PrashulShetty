...
<legend style="color:Blue;padding-top:10px;margin-left:100px;">EMPLOYEE LOGIN</legend>
<form action="./login3" method="post" style="width:200px; heigth:150px;"   >

 
<table>
<tr>
<td style="padding-top:30px;padding-left:20px">Employee ID</td>
<td style="padding-top:30px;padding-left:20px">:</td>
<td style="padding-top:30px;padding-left:20px"><input type="email" name="empId"  placeholder="vailidemail@gmail.com" required></td>
</tr>
<tr>
<td></td>
